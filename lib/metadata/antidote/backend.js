...
*/
    ...
    createBucket(bucketName, bucketMD, log, cb) {
        this.getBucketAttributes(bucketName, log, (err, bucket) => {
            ...
            const antidote_index = this.chooseAntitode(bucketName, this.tailleTab)
            this.antidoteCourant=this.antidote[antidote_index];
            process.stdout.write("\n \n function createBucket - antidote_index: " + antidote_index+" \n \n");
...
*/
    ...
    deleteBucket(bucketName, log, cb) {
        this.getBucketAttributes(bucketName, log, (err, bucket)  => {
            ...
            const antidote_index = this.chooseAntitode(bucketName, this.tailleTab)
            this.antidoteCourant=this.antidote[antidote_index];
            process.stdout.write("\n \n function deleteBucket - antidote_index: " + antidote_index+" \n \n");
