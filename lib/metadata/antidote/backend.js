...
var antidoteCli = require("S3/ib/metadata/antidote/antidote_transaction.js") //changer le path
...
*/
    ...
    createBucket(bucketName, bucketMD, log, cb) {
      ...
      let antidoteCli = require("S3/ib/metadata/antidote/antidote_transaction.js") //changer le path
      let antidotedb = antidoteCli.connect(8187, 'localhost');
      antidoteCli.startTx(antidotedb, (tx) => {
          antidoteCli.updateSet(tx, 'keys', 'c', (tx) => {
              antidoteCli.readSet(tx, 'keys', (tx, result) => {
                  console.log(result);
